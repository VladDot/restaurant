...
export const EventNews: React.FC<IMokCardNewsProps> = ({
  ...
  return (
    <section>
      <div className='container flex flex-col gap-6 py-6 text-[rgba(74,74,74,0.8)]'>
        <h2 className='select-none font-secondFont text-2xl  font-bold '>{content}</h2>
        ...
        {!!descriptionContent?.length && (
          <>
            <h3 className='select-none text-lg font-bold'>{description}</h3>
