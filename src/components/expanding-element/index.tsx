...
export const ExpandingElement: FC<IExpandingElement> = ({
    ...
    return (
        <div
            ref={elementRef}
            className={clsx(
                `cursor-default  w-full lg:w-1/4 last:w-full odd:bg-bgA78963 last:!bg-thirdBg even:bg-thirdBg p-[30px] group hover:!bg-black ${className} transition-all duration-500 easy-in-out `,
                {
