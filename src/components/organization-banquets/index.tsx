            ...
            <div className="container">
                <div className="flex flex-col gap-6 py-8">
                    ...
                    <SubTitle
                        ...
                        text="For organizing banquets"
                    />
                </div>
            </div>

            <div className="flex flex-wrap [&>*:nth-child(odd)>*:nth-child(2)]:bg-opacityBg">
                {organizationBanquets.map(
                    ({ id, imgUrl, altText, title, content }, index) => {
                        return (
                            <div
                                key={`${id}-${index}`}
                            ...
                            >
                                ...
                                <div className="relative z-40 flex flex-col items-center justify-center gap-4 p-7 text-thirdText group/item">
                                    ...
                                    <p className="select-none cursor-auto text-center">
                                        {content}
                                    </p>
                                </div>
                            </div>
