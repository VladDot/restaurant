    ...
    return (
        ...
        >
            <div className="flex items-center">
                <p className="max-w-[200px] sm:max-w-max select-none ">
                    {nameDish}
                </p>

                <span className="border-black sm:border-b border-dotted flex-[1_1] select-none -mb-[5px] mx-2"></span>

                <span className="select-none font-thirdFont text-lg">
                    {prise}
            ...
            <span className="select-none font-thirdFont text-sm font-light">
                {weight}
            </span>
        </div>
    );
