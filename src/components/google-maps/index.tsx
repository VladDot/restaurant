export const GoogleMaps = () => {
  return (
    <section className='w-full p-4 bg-[#05090E] mobile:px-8 md:px-12 md:py-8 xl:p-16 xl:py-10'>
      <div className='border-8 border-double  border-[#A78963] '>
        <iframe
          ...
          title='Google Maps'
          className='aspect-[1/1.3] mobile:aspect-[1/.7] sm:aspect- sm:aspect-[1/.4] border-5 border-double border-[#ff4f4f]'
          loading='lazy'
