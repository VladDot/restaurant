...
export const FormBooking = () => {
  ...
  return (
    <section
      className='min-h-[768px] h-[100vh] bg-fixed bg-cover bg-no-repeat flex items-center justify-center relative'
      style={{
    ...
    >
      ...
      <div className='relative z-40 w-full py-3 flex flex-col gap-2 text-secondText mobile:flex-row flex-wrap mobile:justify-center mobile:items-center'>
        <Title uppercase text='reservation' className='sectionTitle' />
        ...
        >
          {({ isSubmitting }) => (
            <Form className='w-full h-full flex flex-col px-3 gap-6 justify-center items-center min-w-[320px] max-w-[568px]'>
              ...
              <InputNumbers type='tel' name='phone' placeholder='phone' disabled={isSubmitting} />
