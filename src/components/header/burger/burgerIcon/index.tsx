...
export const BurgerIcon: React.FC<MyComponentProps> = ({
    ...
    return (
        <div
            ...
            className={
                isActive === false
                    ? `menu z-[888] desktop:hidden hover:scale-125 transition-all duration-300 pr-7`
                    : `menu active z-[888] desktop:hidden hover:scale-125 transition-all duration-300 pr-7`
            }
        >
